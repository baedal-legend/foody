package com.sparta.baedallegend.auth.filter;

import static com.sparta.baedallegend.auth.exception.AuthErrorCode.IS_NOT_BEARER_TOKEN;
import static com.sparta.baedallegend.auth.utils.jwt.RequestHeaderUtils.BEARER_PREFIX;
import static com.sparta.baedallegend.auth.utils.jwt.RequestHeaderUtils.extractJwt;
...
import com.sparta.baedallegend.auth.utils.jwt.JwtResolver;
...
public class JwtFilter extends OncePerRequestFilter {
	...
	private void checkIsBearerToken(String header) {
		if (!header.startsWith(BEARER_PREFIX)) {
			throw new AuthException(IS_NOT_BEARER_TOKEN);
		}
	}
